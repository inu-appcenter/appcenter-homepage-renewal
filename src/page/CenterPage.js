    ...
    return (
      <>
        ...
        <IntroBox>
            ...
            <Text type='top'>{'동아리원 편성, 기수 관리, 동아리원 정보등을 관리할 수 있어요'}</Text>
        </IntroBox>
        <BoxContainer>
        <Link to="/../manage">
            <InfoBox>
                <DetailText type='title'>{'동아리원 관리'}</DetailText>
                <DetailText type='top'>{'동아리를 추가, 삭제, 수정을 할 수 있어요'}</DetailText>
            </InfoBox>
        </Link>
        <Link to="/../generation">
            <InfoBox>
                <DetailText type='title'>{'기수 관리'}</DetailText>
                <DetailText type='top'>{'동아리원을 기수에 추가, 삭제, 수정을 할 수 있어요'}</DetailText>
            </InfoBox>
        </Link>
      </BoxContainer>
      <BoxContainer>
        <Link to="/../role">
            <InfoBox>
                ...
                <DetailText type='top'>{'역할군을 관리할 수 있어요'}</DetailText>
            </InfoBox>
        </Link>
        <InfoBox>
            <DetailText type='title'>{'전체'}</DetailText>
            <DetailText type='top'>{'홈페이지에 게재된 앱 정보와 목록을 관리할 수 있어요'}</DetailText>
        </InfoBox>
        <Link to="/../product">
            <InfoBox>
