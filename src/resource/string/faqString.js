...
export const faqString = [
    ...
    {id:3, partName: 'Server',url:routerPath.faqDetail.child.server.url,fullUrl:fullPath.server},
    {id:4, partName: 'Web',url:routerPath.faqDetail.child.web.url,fullUrl:fullPath.web},
    {id:5, partName: 'Design',url:routerPath.faqDetail.child.design.url,fullUrl:fullPath.design},
]
